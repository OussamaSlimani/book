document.addEventListener("DOMContentLoaded", function () {
  ...
  // State variables
  let longPressTimer;
  let savedWordIdEn = localStorage.getItem("savedWordIdEn");
  let currentHighlight = null;
  let lastSelectionTime = 0;

  // Check if there's a saved word and highlight it
  if (savedWordIdEn) {
    const savedWord = document.getElementById(savedWordIdEn);
    if (savedWord) {
